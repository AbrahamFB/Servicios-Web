  ...
  <script>
    document.addEventListener("DOMContentLoaded", function(e) {
      ...
      miForm.onsubmit = async function(e) {
        ...
        url = 'https://localhost:44332/api/setUser/get/userInfo/'
  ...
  <div id="box">
    <div class="box">
      ...
      <form action="" method="post" class="form_contact" id="miForm" onsubmit="return false">
        ...
        <br>
        <button onclick="sendForm()" type="submit" class="btn btn-dark" value="Enviar" id="btnSend">Ver información</button>
      </form>
    </div>
    <div class="lista">
      <!--getUserInfo-->
      ...
      <div class="container">
        ...
        <table class="table table-striped">
          <h3> Lista de usuarios y su información </h3>
          <p> </p>
          <thead>
            <tr>
